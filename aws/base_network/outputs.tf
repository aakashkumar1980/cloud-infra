...
output "aa_nvirginia_vpc_names" {
  ...
  description = "Names of VPCs in N. Virginia"
}
...
output "ac_nvirginia_subnet_names" {
  ...
  description = "Names of subnets in N. Virginia"
}
...
output "ba_london_vpc_names" {
  ...
  description = "Names of VPCs in London"
}
...
output "bc_london_subnet_names" {
  ...
  description = "Names of subnets in London"
}
