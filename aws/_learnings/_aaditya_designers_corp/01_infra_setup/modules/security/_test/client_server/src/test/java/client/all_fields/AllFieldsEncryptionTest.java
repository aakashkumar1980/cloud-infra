package client.all_fields;

import client.all_fields.service.HybridEncryptionService;
 ...
 */
@SpringBootTest(
    classes = {server.ServerApplication.class, client.all_fields.TestConfig.class},
